...
FCKConfig.ToolbarSets["Default"] = [
	...
	['TextColor','BGColor']
    */
	['Source','-','Bold','Italic','Underline','StrikeThrough','RemoveFormat','-','Subscript','Superscript','-','OrderedList','UnorderedList','-','Outdent','Indent','Blockquote','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','TextColor','BGColor','-','FontFormat'],
] ;
