<div class="midct midct-half">
    ...
    <div class="midct-cen">
        <div id="tour-ct">
            ...
            <div id="vidct">
                <object width="585" height="355"><param name="movie" value="http://www.youtube.com/v/rKY3-H_blJ8&hl=en&fs=1&rel=0"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/rKY3-H_blJ8&hl=en&fs=1&rel=0" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="585" height="355"></embed></object>
                <!--
